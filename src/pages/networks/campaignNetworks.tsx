    ...
    return (
      <div key={node.id} className="ml-6">
        ...
        <div className="flex items-start gap-3 relative">
          ...
          {/* Card do usuário */}
          <div className="flex-1 min-w-0 p-4 rounded-lg border-2 border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-600 transition-all hover:shadow-md">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-3 mb-2 flex-wrap">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    <span className={`text-xs px-2 py-1 rounded-full border ${getClassBadgeColor(node.networkClass)}`}>
  ...
  const filteredCampaigns = campaignsWithNetworks.filter(campaignWithNetworks => {
    ...
    const matchesClass = filterClass === 'all' || 
      campaignWithNetworks.networks.some(network => 
        network.networkClass === filterClass
      );
                      ...
                      <div className="p-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {Object.entries(stats.classDistribution).map(([className, count]) => (
                            <div key={className} className="flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-gray-600 border border-gray-200 dark:border-gray-500">
            ...
            <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {[1, 2, 3, 4, 5].map(className => (
                  <div key={className} className="flex items-center gap-2 p-2 rounded-lg bg-gray-50 dark:bg-gray-700">
